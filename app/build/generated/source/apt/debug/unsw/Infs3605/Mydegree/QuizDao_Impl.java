...
public class QuizDao_Impl implements QuizDao {
  ...
  @Override
  public LiveData<List<Quiz>> getTopic5() {
    final String _sql = "SELECT * from quiz_table WHERE topic ='5' ORDER BY id ASC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    return new ComputableLiveData<List<Quiz>>() {
      private Observer _observer;
  ...
  @Override
  public LiveData<List<Quiz>> getTopic6() {
    final String _sql = "SELECT * from quiz_table WHERE topic ='6' ORDER BY id ASC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    return new ComputableLiveData<List<Quiz>>() {
      private Observer _observer;
  ...
  @Override
  public LiveData<List<Quiz>> getTopic7() {
    final String _sql = "SELECT * from quiz_table WHERE topic ='7' ORDER BY id ASC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    return new ComputableLiveData<List<Quiz>>() {
      private Observer _observer;
  ...
  @Override
  public LiveData<List<Quiz>> getTopic8() {
    final String _sql = "SELECT * from quiz_table WHERE topic ='8' ORDER BY id ASC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    return new ComputableLiveData<List<Quiz>>() {
      private Observer _observer;
